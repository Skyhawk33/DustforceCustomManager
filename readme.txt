...
"Duplicate" flags the level as a copy of another, and allows it to be filtered with options.
...
Text Entry options:
	...
	- "duplicate":
	    checks if the level has been flagged as a duplicate of another level
